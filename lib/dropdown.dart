...
class _MyDropDown extends State<MyDropDown>{
  ...
  String dataurl = "https://flutter.smartpro.co.tz/city_list.php";
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(title:const Text("City List"), backgroundColor: Colors.redAccent,),
        body:Container(
                  ...
                  child:DropdownButton(
                    ...
                    items: countries.map((countryone){
                      return DropdownMenuItem(
                        value: countryone,
                        child: Text(countryone), //value of item
                      );
                    }).toList(),
                    onChanged: (value){
